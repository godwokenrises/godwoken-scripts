...
int recover_pubkey(unsigned char recovered_pubkey[PUBKEY_SIZE],
  ...
  unsigned char data[sizeof(TRON_SIGNING_PREFIX) - 1 + BLAKE2B_BLOCK_SIZE] =
      TRON_SIGNING_PREFIX;
  memcpy(data + sizeof(TRON_SIGNING_PREFIX) - 1, msg, BLAKE2B_BLOCK_SIZE);
